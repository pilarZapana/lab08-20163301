...
<p>           </p>
	<span class="title">
		<h1 align="center">AGREGAR UN ALUMNO</h1>
	</span>
	<p />
	<p></p>
	<form method="post" action="/alumnos/add" onsubmit="return checkSubmit();">
	...
	<% } %>
			...
			<tr>
				...
				<td bgcolor="#ffffff"><input type="input" name="direccion"  pattern="[A-Za-z0-9. ]*" minlength="3" maxlength="80" required></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgcolor="#ffffff"><input type="number" name="edad" min="1" max="50" required></td>
			</tr>
